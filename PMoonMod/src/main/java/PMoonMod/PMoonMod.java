...
import PMoonMod.util.GeneralUtils;
import PMoonMod.util.KeywordInfo;
import PMoonMod.util.TextureLoader;
...
@SpireInitializer
public class PMoonMod implements
    ...
    private static String checkResourcesPath() {
        String name = PMoonMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + PMoonMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(PMoonMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
