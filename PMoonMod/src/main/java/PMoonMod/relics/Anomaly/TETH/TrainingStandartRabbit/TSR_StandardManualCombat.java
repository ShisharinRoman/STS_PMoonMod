...
public class TSR_StandardManualCombat extends PMoonRelic
{
    private static final String NAME =              "TSR:StandardManualCombat";
    ...
    public TSR_StandardManualCombat() {
        super(NAME, "StandardManualCombat", RARITY, DANGER_LEVEL, SOUND);
    }
